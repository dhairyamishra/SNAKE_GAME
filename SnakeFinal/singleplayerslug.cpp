...
#include "ui_singleplayerslug.h"

SinglePlayerSlug::SinglePlayerSlug(QWidget *parent) :
    QDialog(parent),
    ui(new Ui::SinglePlayerSlug)
{
    ui->setupUi(this);
...
SinglePlayerSlug::~SinglePlayerSlug()
{
    delete ui;
}
...
void SinglePlayerSlug::initGame()
{
    ...
    locateApple();
    timer->start(DELAY-50);

}

void SinglePlayerSlug::locateApple()
{
...
void SinglePlayerSlug::checkApple()
{
...
void SinglePlayerSlug::paintEvent(QPaintEvent *e)
{
    Q_UNUSED(e);
    doDrawing();
...
void SinglePlayerSlug::timerEventS()
{
    if (inGame) {
        checkApple();
        move();
...
void SinglePlayerSlug::checkScore(QPainter &qp)
{
...
void SinglePlayerSlug::keyPressEvent(QKeyEvent *e)
{
    int key = e->key();
...
void SinglePlayerSlug::doDrawing()
{
    QPainter qp(this);
    qp.setPen(5);
...
void SinglePlayerSlug::gameOver(QPainter &qp)
{
...
void SinglePlayerSlug::checkCollision()
{
