...
#include "ui_singleplayerworm.h"

SinglePlayerWorm::SinglePlayerWorm(QWidget *parent) :
    QDialog(parent),
    ui(new Ui::SinglePlayerWorm)
{
    ui->setupUi(this);
...
SinglePlayerWorm::~SinglePlayerWorm()
{
    delete ui;
}


void SinglePlayerWorm::initGame()
{
...
void SinglePlayerWorm::locateApple()
{
...
void SinglePlayerWorm::checkApple()
{
...
void SinglePlayerWorm::paintEvent(QPaintEvent *e)
{
    Q_UNUSED(e);
    doDrawing();
...
void SinglePlayerWorm::timerEventS()
{
    if (inGame) {
        checkApple();
        move();
...
void SinglePlayerWorm::checkScore(QPainter &qp)
{
...
void SinglePlayerWorm::keyPressEvent(QKeyEvent *e)
{
    int key = e->key();
...
void SinglePlayerWorm::doDrawing()
{
    QPainter qp(this);
    qp.setPen(5);
...
void SinglePlayerWorm::gameOver(QPainter &qp)
{
...
void SinglePlayerWorm::checkCollision()
{
