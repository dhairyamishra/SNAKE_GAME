...
#include "ui_twoplayerslug.h"

TwoPlayerSlug::TwoPlayerSlug(QWidget *parent) :
    QDialog(parent),
    ui(new Ui::TwoPlayerSlug)
{
    ui->setupUi(this);
...
TwoPlayerSlug::~TwoPlayerSlug()
{delete ui;}

void TwoPlayerSlug::timerEventS()
{
    move();
    checkApple();
    checkCollision();
...
void TwoPlayerSlug::paintEvent(QPaintEvent *e)
{
    Q_UNUSED(e);
    doDrawing();
}
void TwoPlayerSlug::doDrawing()
{
     QPainter qp(this);
...
void TwoPlayerSlug::keyPressEvent(QKeyEvent *e)
{
    int key = e->key();
    if(inGame)
    {
...
void TwoPlayerSlug::checkScore(QPainter &qp)
{
...
void TwoPlayerSlug::gameOver(QPainter &qp)
{
...
void TwoPlayerSlug::locateApple()
{
...
void TwoPlayerSlug::initGame(int mode)
{
...
void TwoPlayerSlug::checkCollision()
{
    if(inGame)
    {
