...
#include "ui_twoplayerworm.h"

TwoPlayerWorm::TwoPlayerWorm(QWidget *parent) :
    QDialog(parent),
    ui(new Ui::TwoPlayerWorm)
{
    ui->setupUi(this);
...
TwoPlayerWorm::~TwoPlayerWorm()
{delete ui;}

void TwoPlayerWorm::timerEventS()
{
    move();
    checkApple();
    checkCollision();
...
void TwoPlayerWorm::paintEvent(QPaintEvent *e)
{
    Q_UNUSED(e);
    doDrawing();
}
void TwoPlayerWorm::doDrawing()
{
     QPainter qp(this);
...
void TwoPlayerWorm::keyPressEvent(QKeyEvent *e)
{
    int key = e->key();
    if(inGame)
    {
...
void TwoPlayerWorm::checkScore(QPainter &qp)
{
...
void TwoPlayerWorm::gameOver(QPainter &qp)
{
...
void TwoPlayerWorm::locateApple()
{
...
void TwoPlayerWorm::initGame(int mode)
{
...
void TwoPlayerWorm::checkCollision()
{
    if(inGame)
    {
